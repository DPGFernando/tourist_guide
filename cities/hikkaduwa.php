...
<body style = "background-image: url(hikkaduwa.png); background-size: cover; background-repeat: no-repeat ; background-attachment: fixed;">
<div class="header-bar">
        ...
        include("../connection.php");
            ...
            $sql = "select * from user where location = 'hikkaduwa'";
