...
<body style = "background-image: url(kandy.png); background-size: cover; background-repeat: no-repeat ; background-attachment: fixed;">
<div class="header-bar">
        ...
        include("../connection.php");
            ...
            $sql = "select * from user where location = 'kandy'";
